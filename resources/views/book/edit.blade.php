                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="inputName" class="form-control" name="name" value="{{$book->name}}">
                                </div>
                                <div class="form-group">
                                    <label for="inputName">Author</label>
                                    <input type="text" id="inputName" class="form-control" name="author" value="{{$book->author}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="inputName" class="form-control" name="desc" >{{$book->description}}</textarea>
                                </div>
                                <div class="form-group">
